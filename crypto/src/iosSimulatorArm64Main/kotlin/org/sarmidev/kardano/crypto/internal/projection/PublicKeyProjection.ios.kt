 ...
 * build. No handwritten Ed25519 math. Compile+link verified; on-device/simulator runtime
 * execution is recorded as future work, same posture as the 1.6b/1.6c iOS checkpoints.
 *
 ...
 *
 * Duplicated in `iosArm64Main` (this project has no shared `iosMain` source set — see
