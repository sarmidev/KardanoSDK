...
import org.sarmidev.kardano.encoding.cbor.CborError.ByteStringTooLong
import org.sarmidev.kardano.encoding.cbor.CborError.CollectionTooLarge
import org.sarmidev.kardano.encoding.cbor.CborError.DeclaredLengthExceedsInput
import org.sarmidev.kardano.encoding.cbor.CborError.DuplicateMapKey
import org.sarmidev.kardano.encoding.cbor.CborError.EmptyInput
import org.sarmidev.kardano.encoding.cbor.CborError.FloatOrSimpleNotSupported
import org.sarmidev.kardano.encoding.cbor.CborError.IndefiniteLengthNotSupported
import org.sarmidev.kardano.encoding.cbor.CborError.InputTooLong
import org.sarmidev.kardano.encoding.cbor.CborError.IntegerOutOfRange
import org.sarmidev.kardano.encoding.cbor.CborError.InvalidUtf8
import org.sarmidev.kardano.encoding.cbor.CborError.LengthOutOfRange
import org.sarmidev.kardano.encoding.cbor.CborError.MaxNestingDepthExceeded
import org.sarmidev.kardano.encoding.cbor.CborError.NegativeValueNonNegative
import org.sarmidev.kardano.encoding.cbor.CborError.NonCanonicalInteger
import org.sarmidev.kardano.encoding.cbor.CborError.NonCanonicalLength
import org.sarmidev.kardano.encoding.cbor.CborError.NonCanonicalMapKeyOrder
import org.sarmidev.kardano.encoding.cbor.CborError.ReservedAdditionalInfo
import org.sarmidev.kardano.encoding.cbor.CborError.TagsNotSupported
import org.sarmidev.kardano.encoding.cbor.CborError.TextStringTooLong
import org.sarmidev.kardano.encoding.cbor.CborError.TrailingBytes
