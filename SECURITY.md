...
This is the canonical security policy for the repository. Older links under
`docs/SECURITY.md` point here.
...
timeline with you. That aim is not a service-level commitment.
