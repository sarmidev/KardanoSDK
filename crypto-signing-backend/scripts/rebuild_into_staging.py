...
def collect_provenance(module_root: Path, env: dict[str, str]) -> dict[str, object]:
    ...
    return {
        ...
        "windows_msvc_link_version": toolchain.EXPECTED_MSVC_LINK_VERSION,
        "windows_sdk_version": toolchain.EXPECTED_WINDOWS_SDK_VERSION,
        "selected_msvc_link": env.get("KARDANO_MSVC_LINK", ""),
        "selected_windows_sdk_version": env.get("KARDANO_WINDOWS_SDK_VERSION", ""),
        "selected_windows_sdk_dir": env.get("KARDANO_WINDOWS_SDK_DIR", ""),
